...
<div class="container">
    <div>
        ...
        <form method="get">
            ...
            <p class="text-center">
                ...
                <input type="text" name="search" placeholder="ค้นหาประเภท" value="<?php echo isset($_GET['search']) ? $_GET['search'] : ''; ?>">
    ...
    <div>
        <table class="table table-striped table-bordered text-center">
            <thead>
                <tr>
                    <th scope="col" width="13%">รหัสประเภท</th>
                    <th scope="col" width="10%">รูป</th>
                    <th scope="col" width="30%">ชื่อประเภท</th>
            ...
            <tbody>
                ...
                if ($result) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo '<td><img width="100px" height="80px" src="/images/category/' . $row['id'] . '.jpg" class="dimg-fluid"></td>' . "\n";
                      ...
                      //  echo '<td>' . $row['unit'] . '</td>' . "\n";
                        ...
                        echo $row['issell'] ? "<td><font color='#4CD267'>พร้อมขาย</font></td>\n" : "<td><font color='red'>ไม่พร้อมขาย</font></td>\n";
                        echo '<td>' . "\n";
